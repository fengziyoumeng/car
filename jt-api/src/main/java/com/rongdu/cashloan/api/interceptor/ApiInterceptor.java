...
//			br.close();
	...
	public boolean preHandle(HttpServletRequest request,
		...
		// 版本控制
		// {"state":"10","version":"1.0.0","forceUpdate":"0","msg":"1、优化部分功能\n2、修复部分bug\n3、这就是一次测试测试测试测试","androidDownloadUrl":"http://yqb-app-file.oss-cn-hangzhou.aliyuncs.com/yqb-release.apk"}
		String check_version_android = Global.getValue("check_version_android");
		// {"state":"10","version":"1.0.0","forceUpdate":"0","msg":"版本过低，请卸载旧版本并更新至最新版本！","iosDownloadUrl":"XXXXXX"}
